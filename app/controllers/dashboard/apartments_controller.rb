...
module Dashboard
    class ApartmentsController < Dashboard::DashboardController
        ...
        respond_to do |format|
            if @apartment.save
            format.html { redirect_to dashboard_apartment_url(@apartment), notice: 'Apartment was successfully created.' }
        ...
        respond_to do |format|
            ...
            format.html { redirect_to dashboard_apartment_url(@apartment), notice: 'Apartment was successfully updated.' }
